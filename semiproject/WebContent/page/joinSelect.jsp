...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<div
		class="w3-container w3-light-grey w3-text-dark-grey w3-padding-10 "
	...
	<div class="w3-container w3-light-grey w3-text-dark-grey w3-padding-32"
		id="about">
		...
		<div class="w3-main" style="margin-left: 300px">
			...
			<div
				...
				id="top" style="margin-left: 300px"></div>
			<div
				class="w3-container w3-light-grey w3-center w3-text-dark-grey w3-padding-32"
				id="about">
				<!-- join grid -->
				<div
					class="w3-container w3-light-grey w3-center w3-text-light-grey w3-padding-48"
					id="about">
					<div class="w3-row">
						<div class="w3-row-padding" style="margin: 0 -16px">
							<div class="w3-half w3-margin-bottom">
								<ul class="w3-ul w3-white w3-center ">
									<li class="w3-black w3-xlarge w3-padding-32 "><b><font
											color="white">판매자</font></b></li>
									<li class="w3-padding-16">
										<h3>내 제품을 알리고 싶다면</h3>
										<p class="w3-opacity" style="text-align: center">dddper
											month adsfadsfadsfadfasfadsf adsf adsfad sfad sfasdfadsfads
											asd a adsf ㅇㄻㅇㄴㄻㅇㄴㄻ ㄴㄻㅇㄴ ㅁㅇㄴ
											ㄻㅇㄴ f asd fadsf a dsfadfsad adsfads faㄻㅇㄴㄻㅇㄻ ㅇㄻㅇㄻ ㅇㄹ ㅁㅇㄴㄹ</p>
									</li>
									<li class="w3-light-white w3-padding-24"><a
										href="joinFormMaker.jsp">
