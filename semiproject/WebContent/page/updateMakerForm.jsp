...
<script type="text/javascript">
	...
	function checkAll() {
		...
		if (checkPass == "비밀번호를 확인해주세요") {
			...
			document.updateFormMaker.submit();
		}
	}
</script>
...
<!-- Top menu on small screens -->
	...
	<div class="w3-hide-large" style="margin-top: 83px"></div>
		...
		<div class="w3-content w3-justify">
			...
			이름
        	<div class="w3-section"><input class="form-control"  type="text" name="mname" required="required" value="${sessionScope.mvo.maker_name }"></div>        
			아이디 
        	<div class="w3-section"><input class="form-control"  type="text" name="id" id="id" required="required"	value="${sessionScope.mvo.maker_id }" readonly="readonly"></div>        
			비밀번호 
			...
			주소
        	<div class="w3-section"><input class="form-control" type="text" name="add" required="required" value="${sessionScope.mvo.maker_add }"></div>        
			상호명
        	<div class="w3-section"><input class="form-control"  type="text" name="maker_bname" required="required" value="${sessionScope.mvo.maker_bname }"></div>        
			전화번호 
        	<div class="w3-section"><input class="form-control"  type="text" name="tel" required="required" value="${sessionScope.mvo.maker_tel }"></div>        
			계좌번호 
       		<div class="w3-section"><input class="form-control"  type="text" name="account" required="required" value="${sessionScope.mvo.maker_account }"> </div> 
