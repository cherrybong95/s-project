...
<div class="w3-container w3-light-grey w3-center w3-text-dark-grey w3-padding-32" id="about" >
   ...
   <form action="">
		...
		<table class="table">
		<tr>
			<th>상품번호</th><td><input type="text" name="id" value="${requestScope.pvoInsertList.pno }"  readonly></td>
		</tr>
		<tr>
			<th>상품명</th><td><input type="text" name="name"  value="" required="required"></td>
		</tr>
		<tr>
			<th>사 진 </th><td><input type="text" name="pw"  value=""  required="required"></td>
		</tr>
		<tr>
			<th>가격</th><td><input type="text" name="add" size="30"  value=""  required="required"></td>
		</tr>
		<tr>
